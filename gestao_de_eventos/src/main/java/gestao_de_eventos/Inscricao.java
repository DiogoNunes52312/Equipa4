...
public class Inscricao {
    ...
    public Utilizador getParticipante() { return participante; }
    public void setParticipante(Utilizador participante) { this.participante = participante; }
    ...
    public EstadoInscricao getEstadoInscricao() { return estadoInscricao; }
    public void setEstadoInscricao(EstadoInscricao estadoInscricao) { this.estadoInscricao = estadoInscricao; }
}
